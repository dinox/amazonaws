...
set title "Workload test on Amazon instances (small)"
#set xr [0:20000]
#set logscale x
#set yr [0:1]
...
set output "workload_small.png"

# Two y-axes, here you have to specify which dataset should be plotted with which y-axis
plot "../benchmark/w1_s.dat" using 1:3 t '1 Worker' w lines ls 1 axis x1y2, \
	"../benchmark/w2_s.dat" using 1:3 t '2 Workers' w lines ls 2 axis x1y2, \
    "../benchmark/w4_s.dat" using 1:3 t '4 Workers' w lines ls 3 axis x1y2, \
    "../benchmark/w8_s.dat" using 1:3 t '8 Workers' w lines ls 4 axis x1y2
