...
set title "Latency test on Amazon instances (small)"
#set xr [0:20000]
#set logscale x
#set yr [0:1]
...
set output "latency_fixed_small.png"

# Two y-axes, here you have to specify which dataset should be plotted with which y-axis
plot "../benchmark/w1_s.dat" using 1:($2/1000) t '1 Worker' w lines ls 1, \
	"../benchmark/w2_s.dat" using 1:($2/1000) t '2 Workers' w lines ls 2, \
    "../benchmark/w4_s.dat" using 1:($2/1000) t '4 Workers' w lines ls 3, \
    "../benchmark/w8_s.dat" using 1:($2/1000) t '8 Workers' w lines ls 4
